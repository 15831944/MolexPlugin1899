...
namespace MolexPlugin
{
    ...
    public class DeleteEle
    {
        ...
        public int apply_cb()
        {
            ...
            {
                //---- Enter your callback code here -----
                NXOpen.Assemblies.Component eleCom = selection_Ele.GetSelectedObjects()[0] as NXOpen.Assemblies.Component;
                DeleteElectrodeBuilder builder = new DeleteElectrodeBuilder(eleCom.Prototype as Part);

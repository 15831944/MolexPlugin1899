...
namespace MolexPlugin.DAL
{
    ...
    /// 直加等高等宽加清根
    /// </summary>
    public class PlanarAndZleveAndSufaceAndFlowCutEleTemplate : AbstractElectrodeTemplate
    {
        public PlanarAndZleveAndSufaceAndFlowCutEleTemplate(CompterToolName tool) : base(tool)
        {
        ...
        public override void CreateProgramName()
        {
            ...
            FlowCutCreateOperation fc = new FlowCutCreateOperation(count, toolName);  //清根
            fc.CreateOperationName(1);
            Programs.Add(new ProgramOperationName(count, fc));
            count++;

...
namespace MolexPlugin.DAL
{
    ...
    /// 直加等高
    /// </summary>
    public class PlanarAndZleveEleTemplate : AbstractElectrodeTemplate
    {
        public PlanarAndZleveEleTemplate(CompterToolName tool) : base(tool)
        {
            this.Type = ElectrodeTemplate.PlanarAndZleveEleTemplate;
        }
